...
def hand_pos(landmarks: list[tuple[int, int, int]], image: cv2.typing.MatLike) -> tuple[int, int]:
...
def draw_hand(image: cv2.typing.MatLike) -> cv2.typing.MatLike:
...
def segment_hand(image: cv2.typing.MatLike) -> cv2.typing.MatLike:
